"""Regression checks for the anchor-ops-rotate-guard casebook."""
...
from casebook.harness import assert_expected, anchor_ops_rotate_guard_summary
...
class CasebookTests(unittest.TestCase):
    ...
    def test_named_summary_alias(self) -> None:
        self.assertEqual(anchor_ops_rotate_guard_summary(), assert_expected())
